...
SensorRecord::SensorRecord(int sensor_id, QString tag, QDateTime time, QString description, QString type_tag):
    _sensor_id(sensor_id), _tag(tag), _record_time(time), _description(description), _type_tag(type_tag)
{
